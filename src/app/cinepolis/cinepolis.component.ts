...
export class CinepolisComponent {
  ...
  Calcular(){
    ...
    this.mostrarBoletos=this.boletos;
    ...
    this.descuentocinesco =this.totalDescuento * 0.10;
    this.totalDescuento -= this.descuentocinesco;
    }

    if(parseInt(this.boletos) <=7 && this.totalDescuento>0){
      //obtenemos cual radio esta seleccionado
      if(this.tarjetaseleccionada=='Si'){
        //aplica descuento adicional del 10% por tarjeta cineco
      this.descuentocinesco =this.totalDescuento * 0.10;
      this.totalDescuento -= this.descuentocinesco;
